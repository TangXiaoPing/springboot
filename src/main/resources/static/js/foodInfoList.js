        ...
        tableIns = table.render({
            ...
            , cols: [[
                ...
                , {
                    field: 'avatar',
                    title: '商品图片',
                    templet: '<div onclick="show_img(this)"><img src="{{ d.images}}"></div>',
                    align: 'center'
                }
                , {
                    field: 'foodInfoName',
            ...
            , done: function (res, curr, count) {
                ...
                //得到数据总量
                //console.log(count);
                $("[data-field='foodInfoStatus']").children().each(function () {
                    if ($(this).text() == '0') {
                        $(this).text("已下架")
                    } else if ($(this).text() == '1' || $(this).text() == '2' || $(this).text() == '3' || $(this).text() == '4') {
                        $(this).text("已上架")
                    }
                });
                hoverOpenImg();//显示大图
